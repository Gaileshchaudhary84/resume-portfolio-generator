...
Main Python Application with Automated Model Failover & Selection

Workflow:
1. Load environment variables (.env).
2. Validate and clean input resume from 'resume.txt'.
3. Discover available Gemini models and auto-connect to the active one.
4. Send resume text to Gemini API requesting structured JSON output.
5. Parse returned JSON safely.
6. Render JSON data using 'template.html' and embedded 'style.css'.
7. Save generated portfolio as 'portfolio.html'.
"""
